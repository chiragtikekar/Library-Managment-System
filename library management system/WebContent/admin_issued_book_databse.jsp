...
String sql2="insert into admin_issue_book(student_name,book_name,isbn_no,issued_date,return_date) values('"+is+"','"+ib+"','"+isbn+"','"+date+"','"+ry+"')";
stmt.executeUpdate(sql2);
String sql3="insert into admin_issue_book(username) values('"+un+"')";
