...
Full Name:
<br>
<input type="text" name="full_name" placeholder="firstname middlename lastname">
<br><br>
Mobile No:
<br>
<input type="tel" name="mobile_no" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="123-456-7890">
<br><br>
Email ID:<br>
...
Password:
<br>
<input type="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one
 number and one uppercase and lowercase letter, and at least 8 or more characters" id="p" required>
<br><br>
Confirm Password:
<br>
<input type="password" name="confirm_password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one
